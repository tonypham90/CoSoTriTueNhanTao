...
class Graph:
    ...
    def a_star_algorithm(self, start_node, stop_node, Graph_Name):
        print(f'Tim duong {Graph_Name} theo phuong thuc "A*" tu {start_node} den {stop_node}')
        ...
        while len(open_list) > 0:
            ...
            if n == stop_node:
                ...
                print(f'Greedy count: {len(parents)}')
                return reconst_path
